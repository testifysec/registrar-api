...
func (c *registrarClient) GetNodeRegistrations(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetNodeRegistrationsResponse, error) {
	out := new(GetNodeRegistrationsResponse)
	err := c.cc.Invoke(ctx, "/registrar.Registrar/GetNodeRegistrations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Registrar_GetNodeRegistrations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistrarServer).GetNodeRegistrations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/registrar.Registrar/GetNodeRegistrations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistrarServer).GetNodeRegistrations(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
